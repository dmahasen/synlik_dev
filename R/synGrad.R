...
#' @export
#' 
synGrad <- cmpfun(function(object, param, nsim, covariance, 
                           ...
                           tolVar = 10 * .Machine$double.eps, ...)
{
  ...
  # Reduce the object to "synlik" so that I avoid moving around all the additional 
  # slots of the "synMaxlik" class (for example)
  ...
  # Simulate parameters, then data and tranform it into statistics, possibly in parallel.
  if(multicore) 
  { 
